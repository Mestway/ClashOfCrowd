...
We present features collected for the two aforementioned challenges cases to highlight differences between \emph{DirectAnnotation} and \emph{Bingo} in their ability of soliciting meaning features (Figure~\ref{fig:feature}). From the case for document 1, we noticed that features
